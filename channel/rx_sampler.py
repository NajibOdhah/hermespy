...
class RxSampler:
    ...
    def resample(self, input_signal: np.array) -> np.array:
        ...
        Args:
            input_signal(np.array): Input signal.
            ...
            for signal_index in range(no_tx_signals):
                ...
                for rx_index in range(no_rx_antennas):
                    upsampled_signal = signal.resample_poly(
                        x=input_signal[signal_index][rx_index, :],
                    ...
                    upsampled_tx[signal_index][rx_index, :] = upsampled_signal
